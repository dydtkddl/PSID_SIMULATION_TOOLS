...
#define GMX_SIMD_STRING "AVX_512"
...
#define GMX_SYCL_ACPP 0

/* Define if Intel oneAPI DPC++ is used for SYCL support */
#define GMX_SYCL_DPCPP 0

// Define if AdaptiveCpp has HIP target(s)
#define GMX_ACPP_HAVE_HIP_TARGET 0

// Define if AdaptiveCpp has CUDA target(s)
#define GMX_ACPP_HAVE_CUDA_TARGET 0

// Define if AdaptiveCpp/HIP should have AMD RDNA support (32-wide execution)
#define GMX_ENABLE_AMD_RDNA_SUPPORT 0
...
#define GMX_GPU_HIP 0

/* Define if using HIP unified memory */
#define GMX_GPU_HIP_UNIFIED_MEMORY 0

/* Whether MPI can report its GPU-awareness  */
#define HAVE_MPI_EXT 0
#define MPI_SUPPORTS_CUDA_AWARE_DETECTION 0
#define MPI_SUPPORTS_HIP_AWARE_DETECTION 0
#define MPI_SUPPORTS_ROCM_AWARE_DETECTION 0
#define MPI_SUPPORTS_ZE_AWARE_DETECTION 0

/* Define if HeFFTe library found */
#define GMX_USE_Heffte 0

/* Define if cuFFTMp library found */
#define GMX_USE_cuFFTMp 0

// Cluster size used by GPU nonbonded kernel.
#define GMX_GPU_NB_CLUSTER_SIZE 

// Number of clusters along X in a pair-search grid cell for GPU lists.
#define GMX_GPU_NB_NUM_CLUSTER_PER_CELL_X 2

// Number of clusters along Y in a pair-search grid cell for GPU lists.
#define GMX_GPU_NB_NUM_CLUSTER_PER_CELL_Y 2

// Number of clusters along Z in a pair-search grid cell for GPU lists.
#define GMX_GPU_NB_NUM_CLUSTER_PER_CELL_Z 2

// Disable nbnxm cluster setup splitting
#define GMX_GPU_NB_DISABLE_CLUSTER_PAIR_SPLIT 0
...
#define GMX_DESCRIBE_BLAS "External - detected on the system"

// Describes the origin of LAPACK routines
#define GMX_DESCRIBE_LAPACK "External - detected on the system"
...
#define GMX_ENABLE_NBNXM_CPU_VECTORIZATION 0
