...
set_target_properties(Gromacs::muparser PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libmuparser.so.2.3.4"
  IMPORTED_SONAME_RELEASE "libmuparser.so.2"
  )

list(APPEND _cmake_import_check_targets Gromacs::muparser )
list(APPEND _cmake_import_check_files_for_Gromacs::muparser "${_IMPORT_PREFIX}/lib64/libmuparser.so.2.3.4" )
...
set_target_properties(Gromacs::libgromacs PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libgromacs.so.10.0.0"
  IMPORTED_SONAME_RELEASE "libgromacs.so.10"
  )

list(APPEND _cmake_import_check_targets Gromacs::libgromacs )
list(APPEND _cmake_import_check_files_for_Gromacs::libgromacs "${_IMPORT_PREFIX}/lib64/libgromacs.so.10.0.0" )
