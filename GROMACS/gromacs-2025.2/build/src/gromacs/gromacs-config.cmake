...
if (_libs MATCHES "AdaptiveCpp::acpp-rt")
    include(CMakeFindDependencyMacro)
    if(NOT ACPP_TARGETS AND NOT DEFINED ENV{ACPP_TARGETS} AND NOT ACPP_PLATFORM)
        set(ACPP_TARGETS "omp" CACHE STRING "Required input variable for find_package(adaptivecpp).")
    endif()
    find_dependency(adaptivecpp REQUIRED)
endif()
# TODO(#4720) Remove the branch below when hipSYCL 0.9.4 support is no longer required
if (_libs MATCHES "hipSYCL::hipSYCL-rt")
    include(CMakeFindDependencyMacro)
    if(NOT HIPSYCL_TARGETS AND NOT DEFINED ENV{HIPSYCL_TARGETS} AND NOT HIPSYCL_PLATFORM)
        set(HIPSYCL_TARGETS "omp" CACHE STRING "Required input variable for find_package(hipsycl).")
    endif()
    find_dependency(hipsycl REQUIRED)
endif()
unset(_libs)
...
set(GROMACS_SUFFIX "")
set(GROMACS_CXX_COMPILER "/opt/rh/devtoolset-11/root/usr/bin/g++")
set(GROMACS_CXX_COMPILER_ID "GNU")
set(GROMACS_CXX_COMPILER_VERSION "11.2.1")
